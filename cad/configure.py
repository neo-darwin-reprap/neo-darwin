...
# Build Volume (mm)
BUILD_VOLUME_X = {config_data["BUILD_VOLUME_X"]}
BUILD_VOLUME_Y = {config_data["BUILD_VOLUME_Y"]}
BUILD_VOLUME_Z = {config_data["BUILD_VOLUME_Z"]}
...
SKELETON_X = BUILD_VOLUME_X + {config_data["FRAME_MARGIN_X"]}
SKELETON_Y = BUILD_VOLUME_Y + {config_data["FRAME_MARGIN_Y"]}
SKELETON_Z = BUILD_VOLUME_Z + {config_data["FRAME_MARGIN_Z"]}
