...
This file contains all configuration parameters for the Neo-Darwin 3D printer.
...
# --- FRAME GEOMETRY (Neo-Darwin M12 Frame) ---
...
def print_config_summary():
    ...
    print(f"--- Neo-Darwin Configuration: {{DONOR_TYPE}} Path ---")
